...
const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://ar-gift-website.onrender.com/api';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-gray-200 text-sm font-medium text-[#1d1c1c] hover:bg-gray-50 transition-colors mb-4"
          >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/register" className="text-[#F5A900] font-medium hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
